...
<head lang="en">
	...
	<link href="/backend/img/favicon.144x144.png" rel="apple-touch-icon" type="image/png" sizes="144x144">
	<link href="/backend/img/favicon.114x114.png" rel="apple-touch-icon" type="image/png" sizes="114x114">
	<link href="/backend/img/favicon.72x72.png" rel="apple-touch-icon" type="image/png" sizes="72x72">
	<link href="/backend/img/favicon.57x57.png" rel="apple-touch-icon" type="image/png">
	<link href="/backend/img/favicon.png" rel="icon" type="image/png">
	<link href="/backend/img/favicon.ico" rel="shortcut icon">
  @yield('css')
...
<link rel="stylesheet" href="/backend/css/separate/vendor/lobipanel.min.css">
<link rel="stylesheet" href="/backend/css/lib/jqueryui/jquery-ui.min.css">
<link rel="stylesheet" href="/backend/css/separate/pages/widgets.min.css">
<link rel="stylesheet" href="/backend/css/separate/vendor/bootstrap-select/bootstrap-select.min.css">

    <link rel="stylesheet" href="/backend/css/lib/font-awesome/font-awesome.min.css">
    <link rel="stylesheet" href="/backend/css/lib/bootstrap/bootstrap.min.css">
...
<body class="with-side-menu control-panel control-panel-compact">
	    ...
	    <ul class="side-menu-list">
          ...
          <li class="gold with-sub">
	            <span>
	                ...
	                <span class="lbl">HepsiBurada</span>
	            </span>
	            <ul>
          ...
          <li class="gold with-sub">
	            <span>
	                <i class="font-icon glyphicon glyphicon-tint"></i>
	                <span class="lbl">Aliexpress</span>
	            </span>
	            <ul>
	                <li><a href="theme-side-ebony-clay.html"><span class="lbl">Ebony Clay</span></a></li>
	                <li><a href="theme-side-madison-caribbean.html"><span class="lbl">Madison Caribbean</span></a></li>
          ...
          <li class="green with-sub">
	            <span>
	                <i class="font-icon glyphicon glyphicon-tint"></i>
	                <span class="lbl">GittiGidiyor</span>
	            </span>
	            <ul>
	                <li><a href="theme-side-ebony-clay.html"><span class="lbl">Ebony Clay</span></a></li>
	                <li><a href="theme-side-madison-caribbean.html"><span class="lbl">Madison Caribbean</span></a></li>
  ...
  <div class="control-panel-container">
	...
	<script src="/backend/js/lib/jquery/jquery-3.2.1.min.js"></script>
	<script src="/backend/js/lib/popper/popper.min.js"></script>
	...
	<script src="/backend/js/lib/bootstrap-select/bootstrap-select.min.js"></script>
